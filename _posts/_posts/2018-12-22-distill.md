...
<div class="l-page">
  <iframe src="{{ '/assets/plotly/.html' | relative_url }}" frameborder='0' scrolling='no' height="500px" width="100%" style="border: 1px dashed grey;"></iframe>
</div>
...
and `code` is rendered correctly.
{% enddetails %}
